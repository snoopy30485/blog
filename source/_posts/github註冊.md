...
#### 連上 github 網站輸入使用者名稱、電子郵件信箱、密碼註冊 [點我進入網站](https://github.com/)
...
#### Add a license : 檔案授權使用權限設定。這裡設定 None 的話，代表檔案不授權公開使用，別人來使用你的檔案必須要自行負責，如果設定的是 MIT License 的話，代表檔案可供別人使用於任何用途，甚至修改，其它的 License 選項都有著不同授權的概念，詳細說明可參照旁邊的「i」連進其各種 License 說明網頁
