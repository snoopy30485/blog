...
#### 16. 輸入的密碼不到 8 個字元，所以就會出現密碼強度不足的提醒畫面，如果你需要重新修改密碼，那選擇 No，回到密碼設定畫面，重新輸入一組 8 個字元以上的密碼；否則那就選擇 Yes，繼續使用這組弱密碼
...
#### 26. 下圖 Ubuntu 已安裝完成，需要進行重開機的畫面，選擇 Continue，讓 Ubuntu 重開機
