...
### 創建 VM 時點擊下面的管理有很多設定，本章將介紹比較常用設定，大部分設定基本一看就懂但還是會在做一下介紹
...
### 3. 先佔狀態：Google 會把需要維護等一些狀況導致需要在 24 小時 ( 隨時都有可能關閉不一定是 24 小時 ) 內關機的機器變成先佔模式用的機器，會比較便宜適用於無服務機器
...
### 大部分自看面意思就能知道這個功能是什麼，接下來如果有其他功能，或是有研究一些功能會在文章作增加